...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, frame hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
\addcontentsline{toc}{chapter}{Here is a list of courses:}

\markboth{Here is a list of courses:}{Here is a list of courses:}
